...
public class FakeDataDummyMovie {
    ...
    public static MovieResponse getRemoteMovie(int id) {
        List<MovieResponse> list = new ArrayList<>(generateRemoteDummyMovies());
        int size = generateRemoteDummyMovies().size();
        for (int i=0; i<size; i++) {
            MovieResponse movie = generateRemoteDummyMovies().get(i);
            if (movie.getId() == id) {
                return movie;
            }
        }
    ...
    public static MovieResponse generateRemoteDummyMovie(int id) {
        MovieResponse movieResponse = getRemoteMovie(id);
    ...
    public static MovieEntity generateDummyMovie(int id) {
        MovieResponse movieResponse = getRemoteMovie(id);
        if (movieResponse != null) {
